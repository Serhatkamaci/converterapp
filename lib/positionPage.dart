...
import 'package:convertapp/widget.dart';
  ...
  try{
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        content: TextWidget(data: "Lütfen sayı dışında bir sembol girmeyiniz!"),
      ),
    );
  }
}
  ...
  Future _displayBottomSheet(BuildContext context, var screenWidth, var screenHeight){
    return showModalBottomSheet(
      ...
      builder: (context)=> Stack(
        children: [
          Container(
        child: positionList.length==0 ? Align(
                ...
                title: Align(
                  ...
                  child: Column(
                    children: [
                      Align(
                        alignment: Alignment.topLeft,
                        child: Text("Degree: ${positionList.elementAt(index).split(",")[0]}",
                        style: TextStyle(
                      ...
                      Row(
                        children: [
                          Text("Degree: ${positionList.elementAt(index).split(",")[1].split("-")[0]}",
                          style: TextStyle(
                        fontWeight: FontWeight.bold,
                      )),
                          Text("  Minute: ${positionList.elementAt(index).split(",")[1].split("-")[1]}",
                          style: TextStyle(
                        fontWeight: FontWeight.bold,
                      )),
                        ],
                      ...
                      Row(
                        children: [
                          Text("Degree: ${positionList.elementAt(index).split(",")[2].split("-")[0]}",
                          style: TextStyle(
                        fontWeight: FontWeight.bold,
                      )),
                          Text("  Minute: ${positionList.elementAt(index).split(",")[2].split("-")[1]}",
                          style: TextStyle(
                        fontWeight: FontWeight.bold,
                      )),
                          Text("  Second: ${positionList.elementAt(index).split(",")[2].split("-")[2]}",
                          style: TextStyle(
                        fontWeight: FontWeight.bold,
                      )),
                        ],
